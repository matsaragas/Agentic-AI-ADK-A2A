...
from inventory_tools import get_inventory_info
...
inventory_product_agent = LlmAgent(
    ...
    Provide clear, accurate product information including volume, availability and restocking schedules.
    If asked about multiple products, look up each one.
    Be professional and helpful.
    """,
    tools=[get_inventory_info],  # Register the product lookup tool
)